class UnitConverter:
    ...
    def convertUnits(self, title, old_unit, new_unit, data):
        if old_unit == new_unit:
            return data

        if title == "Temperature":
            return self.convertTemperature(old_unit, new_unit, data)
        elif title == "Humidity":
            return self.convertHumidity(old_unit, new_unit, data)
        elif title == "Pressure":
            return self.convertPressure(old_unit, new_unit, data)
        else:
            return data

    def convertTemperature(self, old_unit, new_unit, data):
        if old_unit == "C":
            if new_unit == "F":
    ...
    def convertHumidity(self, old_unit, new_unit, data):
        if old_unit == "%":
            if new_unit == "g/m³":
    ...
    def convertPressure(self, old_unit, new_unit, data):
        if old_unit == "hPa":
            if new_unit == "bar":
